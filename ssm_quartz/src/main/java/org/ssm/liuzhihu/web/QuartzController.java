...
import org.ssm.liuzhihu.entity.JobEntity;
import org.ssm.liuzhihu.service.QuartzService;
...
public class QuartzController {
	...
	public String edit(HttpServletRequest request, HttpServletResponse response)
		...
		boolean result = quartzService.modifyJobTime(oldjobName, oldjobGroup, oldtriggerName, oldtriggerGroup, jobName,
				jobGroupName, triggerName, triggerGroupName, cron);
		if (result) {
